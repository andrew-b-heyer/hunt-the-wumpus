...
/**
 * Author:   Richie Ren
 * File:     RulesAndCommandsTest.java
 * Purpose:  This is a unit test for RulesAndCommands.
 */

public class RulesAndCommandsTest {

	/**
	 * Method:  testGetInfo() 
	 * Purpose: It tests the getInfo() method. It should return the current set of rules and info.
	 */
	
	@Test
	public void testGetInfo() {
		RulesAndCommands r = new RulesAndCommands();
		String info = "Rules: \n"
		...
		assertTrue(r.getInfo().length() == info.length());
	}
}
